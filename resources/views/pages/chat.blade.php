            ...
            <div class="layers h-100">
                ...
                <div class="layer w-100 fxg-1 scrollable pos-r">
                    <div class="peers fxw-nw ai-c p-20 bdB bgc-white bgcH-grey-50 cur-p">
                        <div class="peer">
                            {{ HTML::image('https://randomuser.me/api/portraits/men/1.jpg', '...', ['class' => 'w-3r h-3r bdrs-50p']) }}
                        </div>
                    ...
                    <div class="peers fxw-nw ai-c p-20 bdB bgc-white bgcH-grey-50 cur-p">
                        <div class="peer">
                            {{ HTML::image('https://randomuser.me/api/portraits/men/2.jpg', '...', ['class' => 'w-3r h-3r bdrs-50p']) }}
                        </div>
                        <div class="peer peer-greed pL-20">
                    ...
                    <div class="peers fxw-nw ai-c p-20 bdB bgc-white bgcH-grey-50 cur-p">
                        <div class="peer">
                            {{ HTML::image('https://randomuser.me/api/portraits/men/3.jpg', '...', ['class' => 'w-3r h-3r bdrs-50p']) }}
                        </div>
                        <div class="peer peer-greed pL-20">
                    ...
                    <div class="peers fxw-nw ai-c p-20 bdB bgc-white bgcH-grey-50 cur-p">
                        <div class="peer">
                            {{ HTML::image('https://randomuser.me/api/portraits/men/4.jpg', '...', ['class' => 'w-3r h-3r bdrs-50p']) }}
                        </div>
                        <div class="peer peer-greed pL-20">
                    ...
                    <div class="peers fxw-nw jc-sb ai-c pY-20 pX-30 bgc-white">
                        <div class="peers ai-c">
                            ...
                            <div class="peer mR-20">
                                {{ HTML::image('https://randomuser.me/api/portraits/men/12.jpg', '...', ['class' => 'w-3r h-3r bdrs-50p']) }}
                            </div>
                            <div class="peer">
