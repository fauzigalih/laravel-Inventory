    ...
    <div class="email-app">
        <div class="email-side-nav remain-height ov-h">
            <div class="h-100 layers">
                <div class="p-20 bgc-grey-100 layer w-100"><a href="{{ url('compose') }}" class="btn btn-danger btn-block">New Message</a></div>
                        ...
                        <div class="peers ai-c jc-sb pX-40 pY-30">
                            <div class="peers peer-greed">
                                <div class="peer mR-20">
                                    {{ HTML::image('https://randomuser.me/api/portraits/men/11.jpg', '...', ['class' => 'bdrs-50p w-3r h-3r']) }}
                                </div>
                                <div class="peer">
